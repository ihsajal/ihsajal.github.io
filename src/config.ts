export const siteConfig = {
  ...
  aboutMe:
    "Ibrahim Hossain Sajal is a postdoctoral fellow at the National Cancer Institute (NCI) with expertise in statistical genetics, biostatistics, and cancer epidemiology. His research focuses on genetic association methods, Bayesian and machine-learning approaches, and the development of personalized cancer risk prediction models, particularly in breast and other cancers. He has extensive experience working with large-scale population and registry data, including BCSC, SEER, and biobank resources, and develops scalable multivariate methods to study complex genetic and molecular mechanisms underlying cancer risk and outcomes.",
